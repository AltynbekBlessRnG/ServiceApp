...
--
-- Честность не менялась: отзывов и оценок по-прежнему нет ни одного, каждая
-- карточка по-прежнему называет себя демонстрационной, аватар — монограмма,
-- а не фотография несуществующего человека.
--
