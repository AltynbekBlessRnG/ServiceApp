...
-- демонстрационный. Отзывов этот файл не создаёт; их добавляет
-- demo-reviews.sql, и там же объяснено, почему решение изменилось и почему
-- оно раскрыто в заметках для проверяющего Apple.
--
