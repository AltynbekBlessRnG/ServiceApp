...
const styles = StyleSheet.create({
  ...
  segmented: { flexDirection: 'row', marginHorizontal: 20, backgroundColor: '#1A1625', borderRadius: 16, padding: 4, marginBottom: 16 },
  segment: { flex: 1, paddingVertical: 12, borderRadius: 12, alignItems: 'center' },
  segmentActive: { backgroundColor: '#2D2638' },
  segmentText: { color: '#A09BAF', fontWeight: '800' },
  segmentTextActive: { color: '#00FFCC' },
  zoneRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 10, paddingHorizontal: 20, marginBottom: 10 },
  zoneChip: { paddingHorizontal: 14, paddingVertical: 10, borderRadius: 999, backgroundColor: '#1A1625' },
